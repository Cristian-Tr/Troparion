document.addEventListener('DOMContentLoaded', function () {
    ...
    if (month == 4) {
        ...
        if (day == 21) {
            ...
            saintName = "Sfinții Împărați Constantin și Elena";
            colors = "red";
            colorCross = "red";
...
//PAPIRUS 4 CU PORUNCI
    ...
    var commands = ['Să iubeşti pe Domnul Dumnezeul tău cu toată inima ta, cu tot sufletul tău şi cu tot cugetul tău!', 'Să iubeşti pe aproapele tău ca pe tine însuţi!', 'Să nu vă jurați nicidecum!', 'Adunaţi-vă comori în cer, unde nici molia, nici rugina nu le strică, unde furii nu le sapă şi nu le fură.', 'Nu vă adunaţi comori pe pământ, unde molia şi rugina le strică şi unde furii le sapă şi le fură.', 'Când faci milostenie, nu trâmbiţa înaintea ta!', 'când faci milostenie, să nu ştie stânga ta ce face dreapta ta, ca milostenia ta să fie într-ascuns şi Tatăl tău, Care vede în ascuns, îţi va răsplăti ţie!', 'Când postiți, nu fiți triști, ca fățarnicii!', 'Nu judecați, ca să nu fiți judecați; căci cu judecata cu care judecați veți fi judecați, și cu măsura cu care măsurați vi se va măsura!', 'Cu judecata cu care judecați, cu aceea veți fi judecați!', 'Cereţi şi vi se va da; căutaţi şi veţi afla; bateţi şi vi se va deschide!', 'Iubiți pe vrăjmașii voștri, binecuvântați pe cei ce vă blestemă, faceți bine celor ce vă urăsc!', 'Rugați-vă pentru cei ce vă vatămă și vă prigonesc, ca să fiți fiii Tatălui vostru Celui din ceruri!', 'ăutaţi mai întâi Împărăţia Cerurilor şi dreptatea Lui şi toate acestea (bunurile de care avem nevoie) se vor adăuga vouă!', 'Cel ce vine la Mine nu va flămânzi!', 'Cel ce ascultă cuvântul Meu și crede în Cel Care M-a trimis pe Mine, are viață veșnică și la judecată nu va veni, ci s-a mutat din moarte la viață.', 'Nu judecați după înfățișare, ci judecați judecată dreaptă.', 'Să vă iubiţi unul pe altul, precum v-am iubit Eu!', 'Voi sunteţi prietenii Mei, dacă faceţi ceea ce vă poruncesc!', 'Cel ce crede în Mine, chiar dacă va muri, va trăi!', 'Dacă păziţi poruncile Mele, veţi rămâne întru iubirea Mea!', 'De Mă iubiţi, păziţi poruncile Mele!', 'Ce-i folosește omului să câștige lumea întreagă, dacă își pierde sufletul?', 'Ce ar putea să dea omul, în schimb, pentru sufletul său?', 'Cel ce va crede și se va boteza, se va mântui; iar cel ce nu va crede se va osândi.', 'Cel ce nu-și ia crucea și nu-Mi urmeză Mie nu este vrednic de Mine!', 'Veniți la Mine toți cei osteniți și împovărați, și Eu vă voi odihni pe voi!', 'Pentru orice cuvânt deșert pe care-l vor rosti, oamenii vor da socoteală în ziua judecății!', 'Oricine se mânie pe fratele său vrednic va fi de osândă!', 'Oricine se uită la femeie, poftind-o, a şi săvârşit adulter cu ea în inima lui!'];
    ...
    var scrollingText = function (el, leftToRightScroll, period) {
        ...
        this.period = parseInt(period, 100) || 15300;
        this.txt = '';
        this.tick();
        this.deleting = false;
    };
