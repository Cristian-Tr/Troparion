document.addEventListener('DOMContentLoaded', function () {
    ...
    if (month == 10) {
        ...
        if (day == 15) {
            saints = "Sfântul Cuvios Paisie de la Neamț (Post)";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 16) {
            saints = "Sfântul Apostol şi Evanghelist Matei (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 17) {
            saints = "Sfântul Ierarh Grigorie Taumaturgul, Episcopul Neocezareei (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 18) {
            saints = "Sfinții Mucenici Platon şi Roman, diaconul (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 19) {
            saints = "Sfântul Proroc Avdie (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 20) {
            saints = "Sfântul Cuvios Grigorie Decapolitul (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 22) {
            saints = "Sfinţii Apostoli Filimon, Arhip şi Onisim (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 23) {
            saints = "Sfântul Cuvios Antonie de la Iezerul Vâlcea (Post)";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 24) {
            saints = "Sfinţii Sfinţiţi Mucenici Clement, Episcopul Romei şi Petru, Episcopul Alexandriei (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 25) {
            saints = "Sfânta Mare Muceniță Ecaterina (Post)";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 26) {
            saints = "Sfântul Cuvios Stelian Paflagonul, ocrotitorul pruncilor (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 27) {
            saints = "Sfântul Mare Mucenic Iacob Persul (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 28) {
            saints = "Sfântul Mucenic Irinarh (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 29) {
            saints = "Sfântul Mucenic Paramon (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 30) {
            saints = "Sfântul Apostol Andrei, cel Întâi Chemat, Ocrotitorul României (Dezlegare la pește)";
            colors = "red";
            colorCross = "red";
    ...
    if (month == 11) {
        ...
        if (day == 1) {
            saints = "Sfântul Proroc Naum (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 2) {
            saints = "Sfântul Cuvios Porfirie Kafsokalivitul (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 3) {
            saints = "Sfântul Cuvios Gheorghe de la Cernica (Dezlegare la pește)";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 4) {
            saints = "Sfânta Mare Muceniță Varvara (Dezlegare la pește)";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 5) {
            saints = "Sfântul Cuvios Sava cel Sfințit (Dezlegare la pește)";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 6) {
            saints = "Sfântul Ierarh Nicolae, Arhiepiscopul Mirelor Lichiei (Dezlegare la pește)";
            colors = "red";
            colorCross = "red";
        ...
        if (day == 7) {
            saints = "Sfânta Muceniță Filofteia de la Curtea de Argeș (Post)";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 8) {
            saints = "Sfântul Cuvios Patapie (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 9) {
            saints = "Zămislirea Sfintei Fecioare Maria de către Sfânta Ana (Dezlegare la pește)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 10) {
            saints = "Sfinţii Mucenici Mina, Ermoghen şi Evgraf (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 11) {
            saints = "Sfântul Cuvios Daniil Stâlpnicul (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 12) {
            saints = "Sfântul Ierarh Spiridon, Episcopul Trimitundei (Dezlegare la pește)";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 13) {
            saints = "Sfântul Ierarh Dosoftei, Mitropolitul Moldovei (Post)";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 14) {
            saints = "Sfinţii Mucenici Tirs, Levchie, Calinic, Filimon, Apolonie şi Arian (Post)";
            colors = "springgreen";
            colorCross = "transparent";
            religiousSongs = "Mucenicii Tăi, Doamne, întru nevoinţele lor, cununile nesctricăciunii au dobândit de la Tine, Dumnezeul nostru. Că având tăria Ta, pe chinuitori au învins; zdrobit-au şi ale demonilor neputincioase îndrăzniri. Pentru rugăciunile lor, mântuieşte sufletele noastre, Hristoase Dumnezeule.";
        }
        ...
        if (day == 15) {
            saints = "Sfântul Sfințit Mucenic Elefterie, Episcopul Iliriei (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 16) {
            saints = "Sfântul Proroc Agheu (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 17) {
            saints = "Sfântul Proroc Daniel și Sfinții trei tineri Anania, Azaria și Misail (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 18) {
            saints = "Sfântul Cuvios Daniil Sihastrul (Post)";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 19) {
            saints = "Sfântul Mucenic Bonifatie (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 20) {
            saints = "Sfântul Sfințit Mucenic Ignatie Teoforul, Episcopul Antiohiei (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 21) {
            saints = "Sfânta Muceniță Iuliana din Nicomidia (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 22) {
            saints = "Sfântul Ierarh Petru Movilă, Mitropolitul Kievului (Post)";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 23) {
            saints = "Sfântul Cuvios Naum (Post)";
            colors = "springgreen";
            colorCross = "transparent";
        ...
        if (day == 24) {
            saints = "Sfânta Muceniță Eugenia (Post)";
            colors = "springgreen";
            colorCross = "transparent";
    ...
    if (month == 1) {
        ...
        if (day == 10) {
            saints = "Sfântul Sfințit Mucenic Haralambie";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 18) {
            saints = "Sfântul Ierarh Leon, Episcopul Romei";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 24) {
            saints = "Întâia și a doua aflare a Capului Sfântului Ioan, Înaintemergătorul și Botezătorul Domnului";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
    ...
    if (month == 2) {
        ...
        if (day == 9) {
            saints = "Sfinții 40 de Mucenici din Sevastia";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
    ...
    if (month == 3) {
        ...
        if (day == 11) {
            saints = "Sfântul Ierarh Calinic de la Cernica, Episcopul Râmnicului";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 12) {
            saints = "Sfântul Mucenic Sava de la Buzău";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
            religiousSongs = "Purtătorule de chinuri Sfinte Mucenice Sava, cel ce în apă ai fost omorât de către goţii păgâni, roagă pe Milostivul Dumnezeu ca să dea iertare de greşeli sufletelor noastre.";
        }
        ...
        if (day == 14) {
            saints = "Sfântul Ierarh Pahomie de la Gledin, Episcopul Romanului";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 20) {
            saints = "Sfântul Ierarh Teotim, Episcopul Tomisului";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 23) {
            saints = "Sfântul Mare Mucenic Gheorghe, Purtătorul de biruință";
            colors = "red";
            colorCross = "red";
        ...
        if (day == 24) {
            saints = "Sfântul Ierarh Sava Brancovici, Mitropolitul Transilvaniei şi Sfântul Ierarh Sava Brancovici, Mitropolitul Transilvaniei";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
    ...
    if (month == 4) {
        ...
        if (day == 2) {
            saints = "Sfântul Ierarh Atanasie al III-lea, Patriarhul Constantinopolului";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 3) {
            saints = "Sfântul Cuvios Irodion de la Lainici";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 8) {
            saints = "Sfântul Apostol și Evanghelist Ioan";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 12) {
            saints = "Sfântul Mucenic Ioan Valahul";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
        ...
        if (day == 21) {
            saints = "Sfinții Împărați și întocmai cu Apostolii Constantin și mama sa, Elena";
            colors = "red";
            colorCross = "red";
        ...
        if (day == 25) {
            saints = "A treia aflare a Capului Sfântului Ioan, Înaintemergătorul și Botezătorul Domnului";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
    ...
    if (month == 5) {
        ...
        if (day == 24) {
            saints = "Nașterea Sfântului Ioan Botezătorul (Sânzienele - Drăgaica)";
            colors = "red";
            colorCross = "red";
        ...
        if (day == 29) {
            saints = "Sfinții Apostoli Petru și Pavel";
            colors = "red";
            colorCross = "red";
        ...
        if (day == 30) {
            saints = "Soborul Sfinților 12 Apostoli";
            colors = "cornflowerblue";
            colorCross = "cornflowerblue";
